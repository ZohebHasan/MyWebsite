...
const AccessibilityDropDownButton: React.FC = () => {
    const { isDarkMode,
        ...
        addProtectedRef,
        removeProtectedRef } = useDarkMode();

    const CloseLight = "https://zohebhasan.com/assets/closeColorblindLight.webp";
    const CloseDark = "https://zohebhasan.com/assets/closeColorblindDark.webp";

    const OpenLight = "https://zohebhasan.com/assets/openLight.webp";
    const OpenDark = "https://zohebhasan.com/assets/openDark.webp";
